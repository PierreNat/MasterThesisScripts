...
def main():
    ...
    file_name_extension = 'finaltest'

    # ----------- INSERT HERE THE NUMBER OF IMAGE TO PRODUCE ------------------------
    nb_im = 1 #produce one image for the 1 image test convergenc
...
#----------- INSERT HERE THE TRANSLATION AND ROTATION PARAMETER ------------------------
