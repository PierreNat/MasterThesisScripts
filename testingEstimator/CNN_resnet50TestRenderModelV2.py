"""
script to test the Renderer estimator
...
n_epochs = 2
modelName = 'RendererModelExampleEpoch{}RotationTranslationGammaR'.format(n_epochs)


file_name_extension = 'wrist1im_Head_1000img_sequence_GammaRotationTranslation180'  # choose the corresponding database to use
...
date4File = '082319' #mmddyy
fileExtension = '{}_example{}Lr0_0001'.format(date4File,n_epochs) #string to ad at the end of the file
