...
class Renderer(nn.Module):
    def __init__(self, image_size=256, anti_aliasing=True, background_color=[220,220,220],
                 ...
                 near=0.1, far=1000,
                 light_intensity_ambient=0.3, light_intensity_directional=0.3,
                 light_color_ambient=[1,1,1], light_color_directional=[1,1,1],
                 light_direction=[0,1,0]):
        super().__init__() #super(Renderer, self).__init__()
        # rendering
