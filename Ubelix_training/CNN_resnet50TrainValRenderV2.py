...
"""
script to train Renderer estimator
"""
import torch
import argparse
import os
...
#use this if you want to continue training from a previous model
# modelName = 'Ubelix_lr0_0001_15000GammaR_30epochs_082019_Ubelix_lr0_0001_15000GammaR_30epochs_FinalModel_train_cubes_wrist1im_Head_15000datasetRotationTranslationGamma0_180_M_15_15_5_7_8batchs_30epochs_Render'
...
fileExtension = 'Ubelix_lr0_0001_15000_180_abcR_50_6param' #string to ad at the end of the file
...
date4File = '082119_{}'.format(fileExtension) #mmddyy
...
#torch.save(model.state_dict(), 'models/render/{}_FinalModel_train_{}_{}batchs_{}epochs_Noise{}_{}_RenderRegr.pth'.format(date4File, cubeSetName, str(batch_size), str(n_epochs), noise*100,fileExtension))
